...
- **Cache Class**: Responsible for managing the caching of HTTP requests.
- **Controller Class**: Serves as the central class that manages and communicates with other classes or objects. It is responsible for loading styles and scripts, adding rewrite rules, handling AJAX calls, etc.
...
- **Main Class**: The main class of the plugin, responsible for initializing key components and managing the activation and deactivation of the plugin.
